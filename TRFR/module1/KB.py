class KB(object):
	...
	def addRelation(self, entity1, relation, entity2):
		...
		#if entity1 not in self.entities2:
			#self.entities2.append(entity1)
	...
	def pickRandomIntermediatesBetween(self, entity1, entity2, num):
		...
		import random
		import re
		#for i in range(len(self.entities2)):
			#print(self.entities[i])
			#print(re.match('E-person:',self.entities2[i]))
			#if re.match('E-person:',self.entities2[i]):
				#self.entities_tag[i]=self.entities2[i]
